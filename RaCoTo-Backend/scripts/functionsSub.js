async function main() {
  ...
  // Set your consumer contract address. This contract will be added as an approved consumer of the subscription.
  const consumer = "your_consumer_contract_address"
  ...
  // Checking for a sufficent LINK balance to fund the subscription
  ...
  //Authorizing deployed contract to use new subscription
