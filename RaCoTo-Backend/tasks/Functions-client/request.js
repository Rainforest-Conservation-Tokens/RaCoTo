...
task("functions-request", "Initiates a request from a Functions client contract")
  ...
  .addParam("racoto", "Address of the RaCoToUser contract")
  .addOptionalParam(
    "simulate",
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const RaCoToUserAddr = taskArgs.racoto
    ...
    const RaCoToUser = RaCoToUserContract.attach(RaCoToUserAddr)

    const geoJSON = await RaCoToUser.getgeoJSON(accounts[0].address)
