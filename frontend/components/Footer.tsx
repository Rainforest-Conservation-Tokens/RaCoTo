...
const Footer = () => {
  ...
  const LINKS = [
    {
      title: "Product",
      items: ["Overview", "Features", "WhitePaper", "LitePaper"],
    },
    {
      title: "Company",
  ...
  return (
    <footer className="relative w-full font-proxima">
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <span className="mx-2">
            <img src="/loho-w.png" alt="logo" className="w-[30%]" />
          </span>
          <div className="grid grid-cols-3 justify-between gap-4">
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                <h2
                  color="blue-gray"
                  className="mb-3 font-medium opacity-40 font-proxima_semibold"
                >
                  {title}
                </h2>
                {items.map((link) => (
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          <h2 className="mb-4 text-center font-normal text-blue-gray-900 md:mb-0">
            ...
            <a href="https://material-tailwind.com/">
              RaCoTo Chainlink Spring Hackathon
            </a>
            . All Rights Reserved.
          </h2>
